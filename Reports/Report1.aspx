<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Report1.aspx.cs" Inherits="Reports_Report1" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" BorderStyle="None" EnableTheming="True" ToolPanelView="None" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
