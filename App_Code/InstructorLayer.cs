...
public static class InstructorLayer
{
    ...
    public static int InsertInstructor(string Ins_Name, int? Ins_Age, string Ins_Address, int Dept_Id,int? Ins_Salary)
    {
        ...
        SqlParameter[] p = new SqlParameter[] { new SqlParameter("@Ins_Name", Ins_Name),
            ...
            new SqlParameter("@Ins_Salary", Ins_Salary??SqlInt32.Null)
        };
        return DataAccessLayer.DMLCommandSP(s, p);
    }
    public static int UpdateInstructor(string Ins_Name, int? Ins_Age, string Ins_Address,  int? Ins_Salary, int Dept_Id)   {
